...
public class BookManagement {
    ...
    static final String DB_URL =
        "jdbc:postgresql://aws-1-ap-southeast-1.pooler.supabase.com:5432/postgres?connectTimeout=10";

    static final String USER = "postgres.ahzqastikbltulyuuaxg";
    static final String PASSWORD = "sayandas@2005";
